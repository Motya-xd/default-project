...
// GQ page
MACRO_CONFIG_INT(BcGqAnimatedBackground, bc_gq_animated_background, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show the procedural animated GQ background")
MACRO_CONFIG_INT(BcGqBackgroundCubes, bc_gq_background_cubes, 7, 1, 10, CFGFLAG_CLIENT | CFGFLAG_SAVE, "GQ cube count")
MACRO_CONFIG_INT(BcGqBackgroundCubeSize, bc_gq_background_cube_size, 100, 50, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "GQ cube size")
MACRO_CONFIG_INT(BcGqBackgroundCubeSpeed, bc_gq_background_cube_speed, 100, 0, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "GQ animation speed")
MACRO_CONFIG_INT(BcGqBackgroundTriangles, bc_gq_background_triangles, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show GQ triangles")
...
MACRO_CONFIG_INT(BcGqShotgunThickness, bc_gq_shotgun_thickness, 100, 25, 300, CFGFLAG_CLIENT | CFGFLAG_SAVE, "GQ shotgun effect thickness")
MACRO_CONFIG_INT(BcGqLaserThickness, bc_gq_laser_thickness, 100, 25, 300, CFGFLAG_CLIENT | CFGFLAG_SAVE, "GQ laser effect thickness")
MACRO_CONFIG_INT(BcGqShotgunGlowPower, bc_gq_shotgun_glow_power, 50, 1, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "GQ shotgun glow power")
MACRO_CONFIG_INT(BcGqLaserGlowPower, bc_gq_laser_glow_power, 50, 1, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "GQ laser glow power")
MACRO_CONFIG_INT(BcGqDummyCopyHud, bc_gq_dummy_copy_hud, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show COPY / NO HOOK HUD")
MACRO_CONFIG_INT(BcGqDummyCopyHudX, bc_gq_dummy_copy_hud_x, 50, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "COPY HUD X")
MACRO_CONFIG_INT(BcGqDummyCopyHudY, bc_gq_dummy_copy_hud_y, 85, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "COPY HUD Y")
MACRO_CONFIG_INT(BcGqDummyCopyHudSize, bc_gq_dummy_copy_hud_size, 100, 20, 300, CFGFLAG_CLIENT | CFGFLAG_SAVE, "COPY HUD size")
MACRO_CONFIG_INT(BcGqDummyCopyHudSide, bc_gq_dummy_copy_hud_side, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Attach COPY HUD to right")
MACRO_CONFIG_COL(BcGqDummyCopyHudColor, bc_gq_dummy_copy_hud_color, 65425, CFGFLAG_CLIENT | CFGFLAG_SAVE, "COPY HUD color")
MACRO_CONFIG_INT(BcGqTowerHud, bc_gq_tower_hud, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show TOWER HUD")
MACRO_CONFIG_INT(BcGqTowerHudX, bc_gq_tower_hud_x, 50, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "TOWER HUD X")
MACRO_CONFIG_INT(BcGqTowerHudY, bc_gq_tower_hud_y, 75, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "TOWER HUD Y")
MACRO_CONFIG_INT(BcGqTowerHudSize, bc_gq_tower_hud_size, 100, 20, 300, CFGFLAG_CLIENT | CFGFLAG_SAVE, "TOWER HUD size")
MACRO_CONFIG_COL(BcGqTowerHudColor, bc_gq_tower_hud_color, 5636095, CFGFLAG_CLIENT | CFGFLAG_SAVE, "TOWER HUD color")
