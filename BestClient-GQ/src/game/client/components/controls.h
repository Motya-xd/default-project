...
public:
	...
	bool m_DummyHammer = false;
	bool m_DummyJump = false;
	bool m_DummyCopyNoHook = false;
	...
	void SetDummyDirection(IConsole::IResult *pResult, int Direction);
	...
	static void ConDummyJump(IConsole::IResult *pResult, void *pUserData);
	static void ConDummyHammer(IConsole::IResult *pResult, void *pUserData);
	static void ConDummyCopy(IConsole::IResult *pResult, void *pUserData);
};
#endif
