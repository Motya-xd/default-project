...
{
	if(!g_Config.m_BcGqTowerHud || !Client()->DummyConnected()) return;
	const int Local = GameClient()->m_aLocalIds[g_Config.m_ClDummy], Dummy = GameClient()->m_aLocalIds[!g_Config.m_ClDummy];
