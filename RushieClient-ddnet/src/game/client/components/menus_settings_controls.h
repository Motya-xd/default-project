...
public:
	...
	void RenderMyBinds(CUIRect MainView);
...
private:
	...
	bool m_GqTransparentStyle = false;
	CScrollRegion m_ShotgunPulseDropDownScrollRegion;
	CScrollRegion m_LaserPulseDropDownScrollRegion;
